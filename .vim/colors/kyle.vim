...
hi VertSplit                 guibg=#212121 guifg=#444444 ctermfg=white ctermbg=234
...
" StatusLine
" Bold
hi User1                     guifg=#eeeeee guibg=#606061 ctermfg=255 ctermbg=241
" Yellow
hi User2                     guifg=#FFAF00 guibg=#606060 ctermfg=214 ctermbg=241
" Green
hi User3                     guifg=#5fff00 guibg=#606060 ctermfg=82 ctermbg=241
" Red
hi User4                     guifg=#870000 guibg=#606060 ctermfg=88 ctermbg=241 
hi User5                     guifg=#e4e4e4 guibg=#606060 ctermfg=254 ctermbg=241 
hi User6                     guifg=#e4e4e4 guibg=#606060 ctermfg=254 ctermbg=241 
hi User7                     guifg=#e4e4e4 guibg=#606060 ctermfg=254 ctermbg=241 
hi User8                     guifg=#e4e4e4 guibg=#606060 ctermfg=254 ctermbg=241 
hi User9                     guifg=#e4e4e4 guibg=#606060 ctermfg=254 ctermbg=241 
...
hi Todo                      guifg=#df5f5f guibg=NONE ctermfg=94
...
" String
hi String                    guifg=#9dc667 guibg=NONE ctermfg=107
...
" Ruby
" ----
hi rubyTodo                  guifg=#fc5858 guibg=NONE ctermfg=167 ctermbg=NONE
...
hi rubyPseudoVariable        guifg=#dd7927 ctermfg=221
hi rubySymbol                guifg=#77b3dd ctermfg=73
hi rubyStringDelimiter       guifg=#87af5f ctermfg=107
hi rubyInstanceVariable      guifg=#c974bf ctermfg=189
hi rubyPredefinedConstant    guifg=#fc5858 ctermfg=167
hi rubyLocalVariableOrMethod guifg=#d7b0fc ctermfg=189
hi rubyBoolean               guifg=#fc5858
...
hi jsObjectKey                guifg=#6D9CBE ctermfg=73
